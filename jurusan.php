                ...
                <?php if (!empty($jurusan)): ?>
                    <?php foreach ($jurusan as $index => $data): ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_jurusan.php?id=<?= $data['id_jurusan']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href="hapus_jurusan.php?id=<?= $data['id_jurusan']; ?>" class="btn btn-danger btn-sm">Hapus</a>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                <?php else: ?>
